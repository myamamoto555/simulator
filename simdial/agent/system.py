    ...
    def state_summary(self):
        ...
        for slot in self.usr_beliefs.values():
            ...
            if max_val is not None:
                ...
                maximum_val = usr_slot.vocabulary[max_val]
                anotation = usr_slot.ans[max_val]
                usr_slots.append({'name':slot.uid, 'max_conf': max_conf, 'max_val': maximum_val, "max_regval":anotation})
            else:
                usr_slots.append({'name':slot.uid, 'max_conf': max_conf, 'max_val': max_val, "max_regval":None})
