...
class User(Agent):
    ...
    def __init__(self, domain, complexity):
        ...
        # print (complexity.multi_goals.keys())
        # print (list(complexity.multi_goals.values()))
        self.goal_cnt = np.random.choice(list(complexity.multi_goals.keys()), p=list(complexity.multi_goals.values()))
        self.goal_ptr = 0
